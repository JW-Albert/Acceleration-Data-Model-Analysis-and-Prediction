...
from models.logistic_regression_model import train_and_evaluate_lr
from models.random_forest_model import train_and_evaluate_rf
from models.svm_model import train_and_evaluate_svm
from models.gradient_boosting_model import train_and_evaluate_gb
...
def main():
    ...
    lr_model, lr_health_index = train_and_evaluate_lr(
        norm_all_features, selected_features,
        os.path.join(output_dir, 'logistic_regression')
    )
    
    # Random Forest
    logging.info("Training Random Forest model...")
    rf_model, rf_health_index = train_and_evaluate_rf(
        norm_all_features, selected_features,
    ...
    svm_model, svm_health_index = train_and_evaluate_svm(
        norm_all_features, selected_features,
        os.path.join(output_dir, 'svm')
    )
    logging.info("SVM training completed!")
    
    # Gradient Boosting
    logging.info("Training Gradient Boosting model...")
    gb_model, gb_health_index = train_and_evaluate_gb(
        norm_all_features, selected_features,
        os.path.join(output_dir, 'gradient_boosting')
    )
    ...
    health_indices = pd.DataFrame({
        ...
        'Logistic_Regression': lr_health_index,
        'Random_Forest': rf_health_index,
        'SVM': svm_health_index,
        'Gradient_Boosting': gb_health_index
    })
